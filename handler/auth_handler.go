...
// @Description Mengubah password user yang sedang login. Membutuhkan token JWT.
// @Tags Auth
// @Accept json
// @Produce json
...
// @Failure 400 {object} model.Response
// @Failure 401 {object} model.Response401
// @Failure 403 {object} model.Response403
...
func ChangePassword(c *fiber.Ctx) error {
	...
	if err := repository.UpdatePassword(&user, hashedPassword); err != nil {
		return c.Status(fiber.StatusInternalServerError).JSON(model.Response{
